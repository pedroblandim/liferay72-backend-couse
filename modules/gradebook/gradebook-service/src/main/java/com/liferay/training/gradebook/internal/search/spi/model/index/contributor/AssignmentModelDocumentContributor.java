...
/**
 * The model document contributor controls which fields are indexed. 
* This class’s contribute method is called each time the add and update 
* methods in the entity’s service layer are called.
* @author pedro
*
*/
@Component(
