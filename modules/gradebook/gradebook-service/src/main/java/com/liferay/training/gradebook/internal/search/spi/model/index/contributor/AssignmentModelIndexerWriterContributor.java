...
/**
 * The Model Indexer Writer Contributor configures the re-indexing 
 * and batch re-indexing behavior for the model entity. This class’s 
 * method is called when a re-index is triggered from the Search 
 * administrative application found in Control Panel → Configuration → Search
 * @author pedro
 *
 */
@Component(
